...
public class ArrayMadLib : MonoBehaviour {
...

	{
		...
		string sentence3 = "Would they want to play with the item in their hands or help with the dogs?" + " eventually they decide to help walk the dogs and they  go off towards the ice cream shop " + verb2 [Random.Range (0, verb2.Length)] + ".";
